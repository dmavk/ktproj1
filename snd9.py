    ...
    <div class="card">
      ...
      <div class="menu-sections">
        ...
        <section class="menu-section">
          ...
          <div class="menu-grid">
            <div class="menu-item"> <a class="btn blue" href="/photo1">📸 사진 신고-1</a> <p>사용자가 현장에서 촬영한 사진과 위치 정보를 업로드해 신고합니다.</p> </div>
            <div class="menu-item"><a class="btn green" href="/photo2">📷 사진신고-2</a> <p>간단 양식으로 사진을 첨부해 즉시 서버로 전송·접수합니다.</p></div>
        ...
        <section class="menu-section">
          ...
          <div class="menu-grid">
            ...
            <div class="menu-item"><a class="btn blue" href="#">🌐 네트워크 상태</a><p>VPN, LTE, 와이파이 등 네트워크 품질 및 지연을 확인합니다.</p></div>
