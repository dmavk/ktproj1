...
<style>
  ...
  /* 🔹 폭 비율 변경: 지도 2/3, 폼 1/3 */
  #grid { display: grid; grid-template-columns: 2fr 1fr; gap: 12px; padding: 10px; }
  
  /* 🔹 높이 기존 700px → 800px (+100px) */
  ...
  <div id="grid">
    <div>
      ...
      <div class="row" style="margin-top:20px;">
        <label style="min-width:40px;">위도(lat)</label><input id="lat" placeholder="37.5665" style="width:200px;" />
        <label style="min-width:40px; margin-left:30px;">경도(lon)</label><input id="lon" placeholder="126.9780" style="width:200px;" />
        <button id="gen" class="primary" style="margin-left:90px; width:150px;">curl 생성</button>
      </div>
    </div>
    ...
    <div>
      ...
      <textarea id="curlbox" spellcheck="false" style="height:250px;"></textarea>
      <label>응답/로그</label>
