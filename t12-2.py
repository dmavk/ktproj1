...
<style>
  :root{
    ...
    --card:#1d2c4d;          /* 카드 */
    --accent:#66c2ff;        /* 포인트 */
    --accent-2:#9dff9d;      /* 보조 포인트 */
    --text:#f1f6ff;          /* 본문 */
    --muted:#c3cde0;         /* 보조 텍스트 */
    --border:rgba(255,255,255,.10);
    --shadow:0 10px 24px rgba(0,0,0,.30);
    --radius:16px;
    --vhpad:180px;           /* 모든 화면의 공통 높이 기준(= /map 과 동일) */
  }
...
<body>
  <div class="wrap">
    ...
    <div class="card" id="home-card">
      <section class="hero">
        <h1>드론연계 산불 화재 지원</h1>
        <p>현장의 드론/센서 이벤트를 실시간으로 수집·검증하고, 알림 대시보드와 지도로 가시화합니다. 아래 메뉴에서 필요 기능으로 이동하세요.</p>
        <div class="cta">
...
dash_app.layout = html.Div(
    ...
    children=[
        ...
        html.Div([
            ...
            html.Span("  |  "),
            html.A("Health", href="/health", target="_blank", style={"color": "white", }),
            html.Span("  |  "),
            html.A("Map", href="/map", target="_blank", style={"color": "white", }),
