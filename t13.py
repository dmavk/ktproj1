  ...
  <div class="wrap">
    ...
    <div class="card" id="home-card">
      ...
      <h3 style="display:flex; align-items:center; gap:10px;">
        ...
        <section style="display:grid; grid-template-columns:repeat(4,1fr); gap:12px; margin-top:20px;">
          <figure style="position:relative; overflow:hidden; border-radius:14px; border:1px solid rgba(255,255,255,0.1); background:#0f1d37;">
            ...
            <figcaption style="position:absolute; left:10px; bottom:10px; padding:6px 10px;
                               border-radius:999px; background:rgba(0,0,0,.35); color:#fff; font-size:12.5px;">
              조기 감지 센서
            </figcaption>
          </figure>
      ...
      <p style="margin-top: 3em;">
            현장의 드론/센서 이벤트를 실시간으로 수집·검증하고, 알림 대시보드와 지도로 가시화합니다. 아래 메뉴에서 필요 기능으로 이동하세요.
        </p>
        <div class="cta" style="display:flex; gap:100px; flex-wrap:wrap; align-items:center;">
          ...
          <a href="/dash"
            ...
            <img src="/static/icons/dbd.ico" alt="대시보드 아이콘"
                 style="width:22px; height:22px; display:block; border-radius:4px;">
            대시보드
          </a>
        ...
        <section style="display:grid; grid-template-columns:repeat(3,1fr); gap:16px; margin-top:40px;">
