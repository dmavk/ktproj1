  ...
  <div class="wrap">
    ...
    <div class="brand" style="display:flex; align-items:center; gap:10px; font-weight:800;">
      <div style="width:40px; height:40px; border-radius:50%; 
        ...
        <img src="/static/icons/drone.ico" alt="드론 아이콘"
        ...
        <section style="display:grid; grid-template-columns:repeat(4,1fr); gap:12px; margin-top:-10px;">
          <figure style="position:relative; overflow:hidden; border-radius:14px; border:1px solid rgba(255,255,255,0.1); background:#0f1d37;">
            ...
            <figcaption style="position:absolute; left:10px; bottom:10px; padding:6px 10px;
                               border-radius:999px; background:rgba(0,0,0,.35); color:#fff; font-size:12.5px; font-weight:bold;">
              조기 감지 센서
            </figcaption>
          </figure>
      ...
      <p style="margin-top: 1em;">
        ...
        <div class="cta" style="display:flex; gap:100px; flex-wrap:wrap; align-items:center; margin-top:5px;">
          ...
          <a href="/dash"
            ...
            <img src="/static/img/dbd.png" alt="대시보드 아이콘"
          ...
          <a href="/map"
             style="display:inline-flex; align-items:center; gap:10px;
                    ...
                    color:#fff; font-weight:800; box-shadow:0 6px 16px rgba(0,0,0,.25);">
            <img src="/static/img/map.png" alt="지도 아이콘"
                 style="width:30px; height:30px; display:block; border-radius:4px;">
            지도 보기
          </a>
          ...
          <a href="/feature1"
             style="display:inline-flex; align-items:center; gap:10px;
                    ...
                    background:linear-gradient(135deg,#36d1dc,#5b86e5);
                    color:#fff; font-weight:800; box-shadow:0 6px 16px rgba(0,0,0,.25);">
            <img src="/static/img/GCS.png" alt="기능1 아이콘"
                 style="width:30px; height:30px; display:block; border-radius:4px;">
            기능1
          </a>
          ...
          <a href="/feature2"
             style="display:inline-flex; align-items:center; gap:10px;
                    ...
                    background:linear-gradient(135deg,#36d1dc,#5b86e5);
                    color:#fff; font-weight:800; box-shadow:0 6px 16px rgba(0,0,0,.25);">
            <img src="/static/img/drone.png" alt="기능2 아이콘"
                 style="width:30px; height:30px; display:block; border-radius:4px;">
            기능2
          </a>
        ...
        <section style="display:grid; grid-template-columns:repeat(3,1fr); gap:16px; margin-top:-10px;">
          <div style="border-radius:12px; background:#1c2a45; padding:20px;">
            ...
            <h3 style="margin:0 0 6px; font-size:18px; display:flex; align-items:center; gap:10px;">
              <img src="/static/icons/dbd.ico" alt="대시보드 아이콘"
                   style="width:20px; height:20px; display:inline-block; border-radius:4px;">
              SNS Dashboard 
            </h3>
            <p>수신된 SNS 알림을 표로 확인하고, 선택한 항목의 Raw JSON을 즉시 분석합니다.</p>
            <a href="/dash" style="display:inline-block; margin-top:10px; padding:10px 14px;
                                   border-radius:8px; background:#0f1d37; color:#fff;
                                   text-decoration:none; font-weight:bold;">대시보드 열기 →</a>
          </div>
        
          <div style="border-radius:12px; background:#1c2a45; padding:20px;">
            <!-- 2) Map 카드 제목 -->
            <h3 style="margin:0 0 6px; font-size:18px; display:flex; align-items:center; gap:10px;">
              <img src="/static/icons/map.ico" alt="지도 아이콘"
                   style="width:20px; height:20px; display:inline-block; border-radius:4px;">
              Geo Map
            </h3>
            <p>메시지에서 추출한 위·경도 좌표를 지도에 표시합니다. 새 좌표가 들어오면 자동 갱신됩니다.</p>
            <a href="/map" style="display:inline-block; margin-top:10px; padding:10px 14px;
                                  border-radius:8px; background:#0f1d37; color:#fff;
                                  text-decoration:none; font-weight:bold;">지도 열기 →</a>
          </div>
          ...
          <div style="border-radius:12px; background:#1c2a45; padding:20px;">
            ...
            <a href="/feature2" style="display:inline-block; margin-top:10px; padding:10px 14px;
                                       border-radius:8px; background:#0f1d37; color:#fff;
                                       text-decoration:none; font-weight:bold;">기능2 열기 →</a>
          </div>
    ...
    <footer>© 드론 연계 서비스 - 실시간 SNS 수신 · 대시보드 · 지도 시각화</footer>
  </div>
...
<body>
  <div class="wrap">
    ...
    <footer style="margin-top:8px; padding-top:8px; border-top:1px solid var(--border); color:var(--muted); font-size:13.5px; text-align:center;">
      © 드론 연계 서비스  · 실시간 SNS 수신 · 대시보드 · 지도 시각화
    </footer>
  </div>
</body>
</html>"""
  ...
  <div class="wrap">
    <div class="topbar">
      <div class="brand" style="display:flex; align-items:center; gap:10px; font-weight:800;">
        <div style="width:40px; height:40px; border-radius:50%; background:#f0f0f0; display:flex; align-items:center; justify-content:center;">
          <img src="/static/icons/drone.ico" alt="드론 아이콘" style="width:40px; height:40px; display:block;">
        </div>
        <div style="font-size:22px;">드론 연계 서비스</div>
      </div>
      <div>
    ...
    <div class="card" id="feat-card">
      <h2 style="margin-top:0; display:flex; align-items:center; gap:10px;">
        <span style="font-size:24px;">🧠</span> 기능1 · 알림 규칙/필터
      </h2>
      ...
      <div style="display:grid; gap:12px; grid-template-columns:repeat(2,1fr); margin-top:16px;">
        <div style="background:#20355f; border:1px solid var(--border); border-radius:12px; padding:14px;">
          <h4 style="margin:0 0 6px;">규칙 예시</h4>
          <ul style="margin:0; padding-left:18px;">
            <li>주요 토픽(산불/연막)만 통과</li>
            <li>온도 &gt; 65℃ AND 연기센서=ON</li>
            <li>텍스트에 'flare|smoke' 포함</li>
          </ul>
        </div>
        <div style="background:#20355f; border:1px solid var(--border); border-radius:12px; padding:14px;">
          <h4 style="margin:0 0 6px;">출력/액션</h4>
          <ul style="margin:0; padding-left:18px;">
            <li>대시보드 강조표시</li>
            <li>웹훅/슬랙/이메일 알림</li>
            <li>지도 마커 강조/자동 맞춤</li>
          </ul>
        </div>
      </div>
    </div>
...
<style>
  ...
  *{box-sizing:border-box} html,body{height:100%}
  ...
  #map{ width:100%; flex:1 1 auto; border-top:1px solid var(--border); border-radius:0 0 var(--radius) var(--radius); }
  ...
  <div class="wrap">
    ...
    <div class="card" id="map-card">
      <div id="controls">
        ...
        <a class="link" href="/health" target="_blank" style="margin-left:auto"></a>
        <label>Rows</label>
  ...
  <script>
    ...
    async function pullAndRender() {
      ...
      try {
        ...
        if (bounds.length > 0 && _shouldFit) { const b = L.latLngBounds(bounds); map.fitBounds(b.pad(0.2)); _shouldFit = false; }
      } catch (e) { console.error(e); }
    }
    let _shouldFit = false;
    document.getElementById('fit').addEventListener('click', () => { _shouldFit = true; pullAndRender(); });
    function schedule(){ const sec = Number(document.getElementById('refresh').value || 5);
...
<head>
  ...
  <meta charset="utf-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1"/>
  <title>드론 연계 서비스  · Dashboard</title>
  {%favicon%}
  {%css%}
  <style>
    :root{
...
dash_app.clientside_callback(
    """
    function(data){
      console.log("📦 store data:", data);   // 전체 data 확인

      const out = [];
      (data || []).forEach((row, idx) => {
        console.log("➡️ row", idx, row);    // 각 row 상세 출력
        ...
        if (String(event_val).trim() === '') {
          if (isObj) {
            const cands = [
              "event","Event","eventType","detail-type","detailType","type",
              "alarmName","Message","message","subject","Subject"
            ];
            for (const k of cands) {
              const v = msg[k];
              if (v != null && String(v).trim() !== '') { 
                event_val = v; 
                console.log("✅ event_val found from", k, "=", v);
                break; 
              }
            }
          }
