...
from requests_toolbelt.utils import dump  # NEW

def log_outgoing(resp):  # NEW
    data = dump.dump_all(resp)
    app.logger.info("Outgoing HTTP (req+resp):\n%s", data.decode("utf-8", "ignore"))
...
def sns_handler():
    ...
    if mtype == "SubscriptionConfirmation":
        ...
        log_outgoing( payload )  # 요청/응답 전문 로깅
...
<body>
  <div class="wrap">
    ...
    <div class="brand" style="display:flex; align-items:center; gap:10px; font-weight:800;">
      ...
      <div style="font-size:20px;">드론 연계 서비스</div>
    </div>
...
dash_app.layout = html.Div(
    ...
    children=[
        html.H3("SNS Webhook Dashboard", style={"marginTop": "10px"}),
        html.Div([
            dbc.InputGroup([
                html.Label("Rows"),
                dcc.Dropdown(
